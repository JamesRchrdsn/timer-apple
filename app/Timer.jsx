...
export const Timer = ({ id }) => {
  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center justify-center gap-1 size-full">
        <CircularProgress
          className="absolute"
...
const TimerControls = ({ id, isRunning, timeLeft }) => {
  ...
  return (
    <>
      <button
        className="absolute flex items-center justify-center p-0 rounded-full bottom-3 left-3 size-7 bg-base-300 text-base-content"
      ...
      <button
        className={clsx(
          "absolute flex items-center justify-center p-0 rounded-full bottom-3 right-3 size-7 ",
          {
